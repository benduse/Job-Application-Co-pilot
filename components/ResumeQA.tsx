...
const ResumeQA: React.FC<ResumeQAProps> = ({ resume }) => {
    ...
    return (
        <div className="mt-6 pt-6 border-t border-slate-700">
            <h3 className="text-lg font-semibold text-white mb-3">Answer Screening Questions</h3>
            <p className="text-sm text-slate-400 mb-4">
                Paste a screening question from a job application and get a draft answer based on your resume.
            </p>
            <TextAreaInput
                id="qa-question"
            ...
            {answer && (
                <div className="mt-4">
                    <h4 className="text-md font-semibold text-slate-300 mb-2">Suggested Answer:</h4>
